...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            AudioListener.volume = prefsVolume;
            //Debug.Log(prefsVolume);
            //Debug.Log(1 - (prefsVolume * -1 / 100));
            RotateView();
            ...
            if (!m_PreviouslyGrounded && m_CharacterController.isGrounded)
            {
                ...
                PlayLandingSound();
                if (fallDamage < -10 && bJump ==false)
                {
                    HealthBar.AdjustCurrentValue(fallDamage);
                    fallDamage = 0;
                }             
                m_MoveDir.y = 0f;
                m_Jumping = false;
        ...
        private void FixedUpdate()
        {
            ...
            {               
                ...
                if(m_MoveDir.y<fallDamage)
                    fallDamage = m_MoveDir.y;
        ...
        private void GetInput(out float speed)
        {
            ...
            m_IsWalking = !Input.GetKey(KeyCode.LeftShift)||!Input.GetKey(KeyCode.W)||Input.GetButton("Fire2");
#endif
            StaminaBar.AdjustCurrentValue(Stamina);
            //Система выносливости для финального билда
